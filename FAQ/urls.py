...
urlpatterns = [
    ...
    path('system/', login_required(include('Systems.urls'))),
    path('issue/', include('Issue.urls')),
    path('accounts/', include('django.contrib.auth.urls')),
    path('accounts/logout', include('django.contrib.auth.urls'), name='logout'),
    path('accounts/login', include('django.contrib.auth.urls'), name='login'),
    path('accounts/password_change', login_required(TemplateView.as_view(template_name='registration/password_change.html')),
